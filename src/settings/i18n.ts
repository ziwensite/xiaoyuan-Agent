...
const ZH_CN = {
  ...
  mode: {
    ...
    customApi: "API 模式",
    autoDesc: "自动检测 OpenCode，有则使用，无则使用自定义 API",
  ...
  knowledge: {
    ...
    opencodePathPlaceholder: "全局写 opencode，非全局写绝对路径",
  ...
  opencode: {
    ...
    agentHint: "点连接测试后可下拉选择；读取失败时可以继续手动填写。",
    host: "Host",
    port: "Port",
    ...
    detectSuccess: (models: number, agents: number) => `检测成功：${models} 个模型，${agents} 个 Agent`,
    detectFailed: "检测失败"
  },
  resources: {
    title: "工作区能力管理",
...
const EN: SettingsCopy = {
  ...
  mode: {
    ...
    customApi: "API Mode",
    autoDesc: "Auto-detect OpenCode; fall back to custom API if unavailable",
  ...
  knowledge: {
    ...
    opencodePathPlaceholder: "Use 'opencode' globally, or enter absolute path",
  ...
  opencode: {
    ...
    refreshModelHint: "Test connection to load models.",
    ...
    agentHint: "Test connection to load Agents. If loading fails, manual entry still works.",
    host: "Host",
    port: "Port",
    providerId: "Provider ID",
    modelId: "Model ID",
    ...
    detectSuccess: (models, agents) => `Detection: ${models} models, ${agents} Agents`,
