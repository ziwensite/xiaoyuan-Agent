export const XIAOYUAN_ICON_ID = "xiaoyuan-logo";

export const XIAOYUAN_ICON_PATHS = [
...
export const XIAOYUAN_ICON_SVG = XIAOYUAN_ICON_PATHS.map((d) => `<path d="${d}" />`).join("");
...
export function renderXiaoyuanIcon(container: HTMLElement): void {
  ...
  for (const d of XIAOYUAN_ICON_PATHS) {
